...
const Navbar = ({ renderThis, setRenderThis } : NavbarProps) => {
  ...
  return (
    <div className={`flex flex-row justify-between p-5 w-[70%] border-t-2 mt-5 ${darkMode ? 'border-t-gray-500' : ''}`}>
        <div className={`flex flex-col ${darkMode ? 'text-gray-400' : 'text-black'} sm:flex-row gap-5`}>
            <button 
